...
function EditAlumni() {
        ...
        try{
            if(tabFromUrl && tabFromUrl.startsWith('edit_alumni-') && tabFromUrl.length > 'edit_alumni-'.length){
                ...
                const fetchAlumni = async () => {
                    const res = await fetch(`/api/event/oneEvent/${alumniSlug}`);
  ...
  const handlealumniImageUpload = async () => {
    try {
      if (!eventImage) {
        setAlumniImageUploadError("Please select event image");
        setTimeout(() => {
      ...
      const fileName = new Date().getTime() + eventImage.name;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`/api/event/updateEvent/${currentUser.message.user._id}/${eventData?.data?._id}`,
        ...
        <div className="mt-4 gap-6 dark:text-gray-500 font-body_font space-y-4 md:grid md:grid-cols-2 md:space-y-0">
          <div className="w-full">
            ...
            <input
              ...
              type="text"
              placeholder= {eventData?.data?.eventName}
              id="eventName"
              onChange={(e) =>
...
{/* Event Veneue */}
          <div className="w-full">
            ...
            <input
              ...
              type="text"
              placeholder={eventData?.data?.eventVenue}
              id="eventVenue"
              onChange={(e) =>
...
{/* Event Date */}
          <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent  text-gray-400 px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700    focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventDate}
              id="eventDate"
              onChange={(e) =>
...
{/* Last Registeration Date  */}
          <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventRegistrationLastDate}
...
<div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventCategory}
              id="eventCategory"
              onChange={(e) =>
...
{/* Team Number */}
          <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.teamNumber} 
              id="teamNumber"
              onChange={(e) =>
          ...
          <div className="col-span-2 grid">
            <div className="w-full">
              ...
              <input
                className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="text"
                placeholder= {eventData?.data?.description}
                id="about"
                onChange={(e) =>
      ...
      <div className="mt-8 border-t border-gray-400 border-dashed">
        ...
        <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventOrganizer}
              id="eventOrganizer"
              onChange={(e) =>
          ...
          <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventRegistrationLink}
          ...
          <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventWinningAmount}
          ...
          <div className="w-full">
            ...
            <input
              className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
              type="text"
              placeholder={eventData?.data?.eventRegistrationAmount}
          ...
          <div className="col-span-2 grid">
            <div className="w-full">
              ...
              <input
                className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="text"
                placeholder={eventData?.data?.eventRules}
                id="eventRules"
                onChange={(e) =>
          ...
          <div className="col-span-2 grid">
            <div className="w-full">
              ...
              <input
                className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="text"
                placeholder={eventData?.data?.eventOrganizerInstagram}
          ...
          <div className="col-span-2 grid">
            <div className="w-full">
              ...
              <input
                ...
                type="text"
                placeholder={eventData?.data?.eventOrganizerLinkedin}
          ...
          <div className="col-span-2 grid">
            <div className="w-full">
              ...
              <input
                className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-500   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="text"
                placeholder={eventData?.data?.eventOrganizerContact}
          ...
          <div className="col-span-2 grid">
            <div className="w-full">
              ...
              <input
                className="flex h-10 w-full rounded-md border border-black/30 bg-transparent px-3 py-2 text-sm dark:border-gray-600 dark:placeholder:text-gray-700 text-gray-400   focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                type="email"
                placeholder={eventData?.data?.eventOrganizerEmail}
